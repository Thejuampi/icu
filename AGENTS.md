...
- `docs/rebalance.md`: dry-run/preview/accept workflow for editable calendar load redistribution proposals
- `docs/plan.md`: intent → show/preview/accept workflow for explicit multi-session calendar writes
