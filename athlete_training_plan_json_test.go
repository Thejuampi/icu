...
func TestAthleteTrainingPlanUnmarshalSnakeCaseFields(t *testing.T) {
	...
	if plan.AthleteID != "i445643" || plan.PlanID != 827693 ||
		plan.PlanStartDate != "2026-06-01" || plan.PlanLastApplied != "2026-05-31T17:00:00Z" {
...
func TestAthleteTrainingPlanUpdateMarshalSnakeCaseFields(t *testing.T) {
	...
	got := string(data)
	want := `{"id":"i445643","training_plan_id":827693,"training_plan_start_date":"2026-06-01","training_plan_alias":"ALT Build Jun 2026"}`
