...
func registerCustomCommands(registry *CommandRegistry) {
	registry.Register("custom", "list", &Command{
		Name:        "",
		Usage:       "custom list",
	...
	registry.Register("custom", "get", &Command{
		Name:        "",
		Usage:       "custom get <id>",
	...
	registry.Register("custom", "create", &Command{
		Name:        "",
	...
	registry.Register("custom", "update", &Command{
		Name:        "",
	...
	registry.Register("custom", "delete", &Command{
		Name:        "",
		...
		Run: func(args []string, _ map[string]string, client *icu.Client) error {
			...
			return wrapCommandError(client.Delete("custom-item", []string{args[0]}, nil, nil))
		},
	})
}
